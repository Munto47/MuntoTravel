...
app = FastAPI(title="MuntoTravel Demo 02", version="0.2.0")
...
async def health() -> dict[str, str]:
    return {"status": "healthy", "app": "MuntoTravel Demo 02"}
...
async def plan_trip(request: TripRequest) -> TripPlanResponse:
    ...
    return TripPlanResponse(success=True, message="行程生成成功", data=plan)
